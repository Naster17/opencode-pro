...
| Agent Manager             | Create, edit, delete, and manage custom agents directly from the app. Fine-tune agent behavior with custom instructions, system prompts, and configuration per agent.                                                                                                                                                                     |
...
| Sidebar Metrics           | Live session metrics in the sidebar with context usage, token totals, cache, tool calls, compactions, speed, and spend. Includes subagent/child sessions.                                                                                                                                                                                 |
...
| Reworked Codex Plugin     | Built-in Codex plugin now supports hot-swap accounts, writes Codex usage statistics, and more. Fully reworked for better reliability and control.                                                                                                                                                                                         |
