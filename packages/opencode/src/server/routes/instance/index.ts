...
export const InstanceRoutes = (upgrade: UpgradeWebSocket, opts?: CorsOptions): Hono => {
  ...
  if (Flag.OPENCODE_EXPERIMENTAL_HTTPAPI) {
    ...
    app.post(InstancePaths.lspInstall, (c) => handler(c.req.raw, context))
    app.post(InstancePaths.lspUninstall, (c) => handler(c.req.raw, context))
    ...
    app.post(SessionPaths.prune, (c) => handler(c.req.raw, context))
    app.post(SessionPaths.truncate, (c) => handler(c.req.raw, context))
    app.get(SessionPaths.shellThreadList, (c) => handler(c.req.raw, context))
    app.post(SessionPaths.shellThreadStop, (c) => handler(c.req.raw, context))
