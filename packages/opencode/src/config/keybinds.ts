...
const KeybindsSchema = Schema.Struct({
  ...
  session_favorite_toggle: keybind("ctrl+f", "Toggle session favorite (pin) status in the session list"),
  ...
  model_cycle_favorite_reverse: keybind("alt+n", "Previous favorite model"),
  ...
  thinking_level_cycle: keybind("ctrl+shift+t,f3", "Cycle thinking level"),
  input_clear: keybind("ctrl+c", "Clear input field"),
  input_paste: keybind("ctrl+v", "Paste from clipboard"),
  input_submit: keybind("return", "Submit input"),
  input_defer_submit: keybind("alt+return,ctrl+return", "Submit input, held until the agent finishes its current turn"),
  input_newline: keybind("shift+return,ctrl+j", "Insert newline in input"),
