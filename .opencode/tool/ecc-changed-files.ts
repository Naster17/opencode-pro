...
import type { ChangeType, TreeNode } from "../plugin/ecc-lib/changed-files-store.js"
...
type ChangedFilesStore = typeof import("../plugin/ecc-lib/changed-files-store.js")
...
async function loadChangedFilesStore(): Promise<ChangedFilesStore> {
  if (!changedFilesStorePromise) {
    changedFilesStorePromise = import("../plugin/ecc-lib/changed-files-store.js").catch(() => {
